  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://backend-production-5c23.up.railway.app/subscribe`,
        { email },
        {
          headers: {
            ...
            <div className="udesly-column-2">
              ...
              <div className="udesly-footer-menu">
                <p>
                  ...
                  enterprises and individuals with creative solutions,
                  converting concepts into achievements, and fostering
                  development through teamwork and expertise.
                </p>
              </div>
            </div>
